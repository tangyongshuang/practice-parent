...
public class FreightOnValueType implements java.io.Serializable {
    ...
    // Constructor
    protected FreightOnValueType(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _CARRIER_RISK = "CARRIER_RISK";
    public static final String _OWN_RISK = "OWN_RISK";
    ...
    public static FreightOnValueType fromValue(String value)
