...
public class CompletedEtdType implements java.io.Serializable {
    ...
    // Constructor
    protected CompletedEtdType(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _ELECTRONIC_DOCUMENTS_ONLY = "ELECTRONIC_DOCUMENTS_ONLY";
    public static final String _ELECTRONIC_DOCUMENTS_WITH_ORIGINALS = "ELECTRONIC_DOCUMENTS_WITH_ORIGINALS";
    ...
    public static CompletedEtdType fromValue(String value)
    ...
    public static CompletedEtdType fromString(String value)
          throws IllegalArgumentException {
