...
public class SmartPostShipmentProcessingOptionType implements java.io.Serializable {
    ...
    // Constructor
    protected SmartPostShipmentProcessingOptionType(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _GROUND_TRACKING_NUMBER_REQUESTED = "GROUND_TRACKING_NUMBER_REQUESTED";
    ...
    public static SmartPostShipmentProcessingOptionType fromValue(String value)
    ...
    public static SmartPostShipmentProcessingOptionType fromString(String value)
          throws IllegalArgumentException {
