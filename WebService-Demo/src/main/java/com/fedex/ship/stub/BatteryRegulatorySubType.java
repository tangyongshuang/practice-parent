...
public class BatteryRegulatorySubType implements java.io.Serializable {
    ...
    // Constructor
    protected BatteryRegulatorySubType(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _IATA_SECTION_II = "IATA_SECTION_II";
    public static final BatteryRegulatorySubType IATA_SECTION_II = new BatteryRegulatorySubType(_IATA_SECTION_II);
    public String getValue() { return _value_;}
    public static BatteryRegulatorySubType fromValue(String value)
    ...
    public static BatteryRegulatorySubType fromString(String value)
          throws IllegalArgumentException {
