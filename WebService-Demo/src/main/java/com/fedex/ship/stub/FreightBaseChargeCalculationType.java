...
public class FreightBaseChargeCalculationType implements java.io.Serializable {
    ...
    // Constructor
    protected FreightBaseChargeCalculationType(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _BEYOND = "BEYOND";
    public static final String _LINE_ITEMS = "LINE_ITEMS";
    public static final String _UNIT_PRICING = "UNIT_PRICING";
    ...
    public static FreightBaseChargeCalculationType fromValue(String value)
