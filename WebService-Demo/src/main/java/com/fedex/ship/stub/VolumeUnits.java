...
public class VolumeUnits implements java.io.Serializable {
    ...
    // Constructor
    protected VolumeUnits(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _CUBIC_FT = "CUBIC_FT";
    public static final String _CUBIC_M = "CUBIC_M";
    ...
    public static VolumeUnits fromValue(String value)
