...
public class ShipmentDryIceProcessingOptionType implements java.io.Serializable {
    ...
    // Constructor
    protected ShipmentDryIceProcessingOptionType(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _SHIPMENT_LEVEL_DRY_ICE_ONLY = "SHIPMENT_LEVEL_DRY_ICE_ONLY";
    ...
    public static ShipmentDryIceProcessingOptionType fromValue(String value)
    ...
    public static ShipmentDryIceProcessingOptionType fromString(String value)
          throws IllegalArgumentException {
