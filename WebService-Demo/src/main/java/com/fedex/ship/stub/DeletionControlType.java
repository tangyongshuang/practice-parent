...
public class DeletionControlType implements java.io.Serializable {
    ...
    // Constructor
    protected DeletionControlType(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _DELETE_ALL_PACKAGES = "DELETE_ALL_PACKAGES";
    public static final String _DELETE_ENTIRE_CONSOLIDATION = "DELETE_ENTIRE_CONSOLIDATION";
    public static final String _DELETE_ONE_PACKAGE = "DELETE_ONE_PACKAGE";
    public static final String _LEGACY = "LEGACY";
    ...
    public static DeletionControlType fromValue(String value)
