...
public class FreightGuaranteeType implements java.io.Serializable {
    ...
    // Constructor
    protected FreightGuaranteeType(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _GUARANTEED_DATE = "GUARANTEED_DATE";
    public static final String _GUARANTEED_MORNING = "GUARANTEED_MORNING";
    ...
    public static FreightGuaranteeType fromValue(String value)
