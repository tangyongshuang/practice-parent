...
public class ShippingDocumentEMailGroupingType implements java.io.Serializable {
    ...
    // Constructor
    protected ShippingDocumentEMailGroupingType(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _BY_RECIPIENT = "BY_RECIPIENT";
    ...
    public static ShippingDocumentEMailGroupingType fromValue(String value)
