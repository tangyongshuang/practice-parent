...
public class SpecialRatingAppliedType implements java.io.Serializable {
    ...
    // Constructor
    protected SpecialRatingAppliedType(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _FEDEX_ONE_RATE = "FEDEX_ONE_RATE";
    public static final String _FIXED_FUEL_SURCHARGE = "FIXED_FUEL_SURCHARGE";
    public static final String _IMPORT_PRICING = "IMPORT_PRICING";
    ...
    public static SpecialRatingAppliedType fromValue(String value)
