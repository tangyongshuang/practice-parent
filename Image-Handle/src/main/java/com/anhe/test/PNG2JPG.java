...
/**
 * Created by Albert.Tang on 2019/4/17 11:29 AM.
 */
/*
 * 图片处理类
 */
...
public class PNG2JPG {
    ...
    public static void main(String[] args) throws IOException {
        File img = new File("/Users/circleus/Documents/issue/DHL的label尾部添加内容/freeformatter-decoded-55.png");
        File save = new File("/Users/circleus/Documents/issue/DHL的label尾部添加内容/test.jpg");
