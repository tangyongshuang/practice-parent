 ...
 * 
 * <p>DangerousGoodsSignatory complex type的 Java 类。
 * 
...
@XmlType(name = "DangerousGoodsSignatory", namespace = "http://fedex.com/ws/ship/v23", propOrder = {
    "contactName",
    "title",
    "place"
})
public class DangerousGoodsSignatory {
    ...
    @XmlElement(name = "ContactName", namespace = "http://fedex.com/ws/ship/v23")
    protected String contactName;
    @XmlElement(name = "Title", namespace = "http://fedex.com/ws/ship/v23")
    protected String title;
    @XmlElement(name = "Place", namespace = "http://fedex.com/ws/ship/v23")
