 ...
 * 
 * <p>DangerousGoodsShippersDeclarationDetail complex type的 Java 类。
 * 
...
@XmlType(name = "DangerousGoodsShippersDeclarationDetail", namespace = "http://fedex.com/ws/ship/v23", propOrder = {
    "format",
    "customerImageUsages"
})
