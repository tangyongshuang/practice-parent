 ...
 * 
 * <p>PendingShipmentAccessDetail complex type的 Java 类。
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="AccessorDetails" type="{http://fedex.com/ws/ship/v23}PendingShipmentAccessorDetail" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PendingShipmentAccessDetail", namespace = "http://fedex.com/ws/ship/v23", propOrder = {
    "accessorDetails"
})
public class PendingShipmentAccessDetail {

    @XmlElement(name = "AccessorDetails", namespace = "http://fedex.com/ws/ship/v23")
