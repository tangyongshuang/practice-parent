 ...
 * 
 * <p>ShipmentLegRateDetail complex type的 Java 类。
 * 
 ...
 *         &lt;element name="LegOrigin" type="{http://fedex.com/ws/ship/v23}Address" minOccurs="0"/>
 *         &lt;element name="LegOriginLocationId" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="LegDestination" type="{http://fedex.com/ws/ship/v23}Address" minOccurs="0"/>
...
@XmlType(name = "ShipmentLegRateDetail", namespace = "http://fedex.com/ws/ship/v23", propOrder = {
    "legDescription",
    "legOrigin",
    "legOriginLocationId",
    "legDestination",
...
public class ShipmentLegRateDetail {
    ...
    @XmlElement(name = "LegDescription", namespace = "http://fedex.com/ws/ship/v23")
    protected String legDescription;
    @XmlElement(name = "LegOrigin", namespace = "http://fedex.com/ws/ship/v23")
    protected Address legOrigin;
    @XmlElement(name = "LegOriginLocationId", namespace = "http://fedex.com/ws/ship/v23")
    protected String legOriginLocationId;
    @XmlElement(name = "LegDestination", namespace = "http://fedex.com/ws/ship/v23")
    protected Address legDestination;
    @XmlElement(name = "LegDestinationLocationId", namespace = "http://fedex.com/ws/ship/v23")
    ...
    /**
     * 获取legDestinationLocationId属性的值。
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * 设置legDestinationLocationId属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link String }
